...
import static jtp.c.dendai.ac.jp.switch3.R.drawable.l;
...
public abstract class MapView extends SurfaceView implements Idealist {
    ...
    private static final int[] ids = {R.drawable.block_b,R.drawable.block_r,R.drawable.g,
            R.drawable.o,R.drawable.a, l};
    private  Context context;

    private Imageint imageint;// = new Imageint(ids);//
    ...
    *
    ...
    public MapView(String filename, Context context, Activity gameActivity) {
        super(context);
        ...
        imageint = new Imageint(ids, context);

        b = imageint.getBit(3);
        b2 = imageint.getBit(2);

        blockImage = imageint.getBit(0);
        blockImage2 = imageint.getBit(1);;
        blockImageG = imageint.getBit(2);;
        blockImageO = imageint.getBit(3);;
        blockImageA = imageint.getBit(4);;
        blockImageL = imageint.getBit(5);;
        // イメージをロードする
        loadImage();
        // loadImage2();
